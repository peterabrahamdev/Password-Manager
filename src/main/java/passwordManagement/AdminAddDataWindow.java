...
public class AdminAddDataWindow implements ActionListener, MouseListener, FocusListener {
    ...
    AdminAddDataWindow(){
        frame = new JFrame();
        frame.setTitle("Adat hozzáadása");
        ...
        xButton.setBounds(70, 444, 45, 30);
            ...
            try {
                ...
                if(num1 < 2){
                    ...
                    if(num2 < 1)
                        ...
                        myMethods.insertRow(num1, num2, accountField, usernameField, passwordAccountField, emailField, detailsField);
                    }
                }
