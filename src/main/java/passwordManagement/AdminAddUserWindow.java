...
public class AdminAddUserWindow implements ActionListener, MouseListener, FocusListener {
    ...
    AdminAddUserWindow() {
        frame = new JFrame();
        frame.setTitle("Fiók hozzáadása");
        ...
        updateButton = new JButton("Hozzáadás");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == updateButton || e.getSource() == usernameField || e.getSource() == passwordAccountField) {
            try {
                ...
                if(num < 2){
                    ...
                    myMethods.insertUser(num, usernameField.getText(), passwordAccountField.getText());
                }
